...
public class HttpProxy {
	...
	/*
	 * /上级代理服务器地址和端口 private static String parent = null; private static
	 * intparentPort = -1; /** 描述：设置上级代理地址和端口，可选方法
	 * 
	 * @param name 描述： @param pport 描述：
	 */
	/*
	...
	public static void startProxy(int port) {
		...
		try {
			...
			System.out.println("在端口25启动代理服务器\n");
