...
public class CopyOfStatisticsManagePanel extends JPanel {
	...
	public CopyOfStatisticsManagePanel(final MainFrame source) {
		this.source = source;
		...
		fistPageButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				list = statisticsPageing
						.pageingBypageNowAndpageSizeObjByCondition(1, numPageInt,"");
				createTable(list);
		...
		nextPageButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (countPage == sumPage) {
					countPage = sumPage;
					JOptionPane.showMessageDialog(CopyOfStatisticsManagePanel.this,
		...
		lastPageButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				statisticsPageing = new StatisticsPageing();
				list = new ArrayList<SendTaskStatisticsObj>();
				list = statisticsPageing.pageingBypageNowAndpageSizeObjByCondition(sumPage,
						numPageInt,conditionSqlStr);
				createTable(list);
				countPage = sumPage;
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (JOptionPane.YES_OPTION == flag) {
					...
					if (count > 0) {
						statisticsPageing  = new StatisticsPageing ();
						list = new ArrayList<SendTaskStatisticsObj>();  
						list = statisticsPageing.pageingBypageNowAndpageSizeObjByCondition(1,
								numPageInt,"");
						createTable(list);
		...
		queryButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (!"".equals(query)&&selectInt>0) {
					...
					list = new ArrayList<SendTaskStatisticsObj>();
					list = statisticsPageing
							.pageingBypageNowAndpageSizeObjByCondition(countPage, numPageInt,conditionSqlStr);
					createTable(list);
