...
//		System.getProperties().setProperty("http.proxyPort", "808"); 
	...
	public void SendMailTrue(SendEmailEntiy sendEmailEntiy,ArrayList<String> receiveMailInfoList) throws MessagingException, UnsupportedEncodingException{
		...
		setMialHost(properties,sendEmailEntiy);//设置邮件服务器信息
...
//		try {
			...
			setReveice(receiveMailInfoList,mimeMessage);//设置收件人
			setAccessorys(multipartMain,mimeMessage);//设置附件
			setTitleContent(mimeMessage,multipartMain,titleMail,"");//设置主题和内容
